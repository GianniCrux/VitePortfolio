...
const Project = ({ title, description, imageUrl, link, previewImage, passkey }) => {
  return (
    <div className="relative group overflow-hidden border border-blue-400 rounded-lg shadow-md w-full h-[250px] transition-all duration-300 hover:shadow-lg hover:border-blue-500">
      <a href={link} target="_blank" rel="noopener noreferrer" className="block p-4 h-full">
        <h3 className="text-lg font-light mb-2 text-blue-600">{title}</h3>
